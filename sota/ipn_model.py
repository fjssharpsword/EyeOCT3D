...
if __name__ == "__main__":
    #for debug  
    scan =  torch.rand(2, 2, 160, 100, 100)#.cuda()
    #model = IPN(in_channels=2, channels=64, n_classes=2)
    model = IPN_V2(in_channels=2, channels=64 ,plane_perceptron_channels=64, \
                n_classes=2, block_size=[160,100,100], plane_perceptron='UNet')
    pred, _= model(scan)
    print(pred.shape)
